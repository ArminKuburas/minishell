...
/*   Updated: 2024/05/23 11:59:53 by akuburas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*Global variable used for two types of signal handeling.*/
extern int	g_exit_value;

/*Not needed for eval but could be fun to explain. color and emoji*/
...
int			check_if_unset_env_exists(t_shelldata *data, char *input);
int			check_if_export_env_exists(t_shelldata *data, char *input);
